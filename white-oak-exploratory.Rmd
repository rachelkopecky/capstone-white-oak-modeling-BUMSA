...
Analysis by state and then aggregate to national at the end

# TO DO

* Filter urbanization data to include only the Eastern states that are relevant to the White Oak analysis. This may or may not impact any correlation in trends that we see.

* Loop through states to analyze correlations/effects at the state level.

...
#2 Year Lag
cor(inventory_pdsi_national$total_inventory[3:12], inventory_pdsi_national$yearly_pdsi[1:10])

#3 Year Lag
cor(inventory_pdsi_national$total_inventory[4:12], inventory_pdsi_national$yearly_pdsi[1:9])
```

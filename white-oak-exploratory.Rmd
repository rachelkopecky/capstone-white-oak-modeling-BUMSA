...
colnames(pdsi_data) <- c("Region_Year","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec")

pdsi_data$Region <- substr(pdsi_data$Region_Year, 1, nchar(pdsi_data$Region_Year)-3)
pdsi_data$Year <- substr(pdsi_data$Region_Year, nchar(pdsi_data$Region_Year)-3, nchar(pdsi_data$Region_Year))
